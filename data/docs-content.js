window.MCCDocContent = {
  ...
  "docs/INTERNAL_ROADMAP.md": [
    ...
    "",
    "**Strategic position:** Free feature (the hook), Pro extension = cloud profile sync across devices.",
    "",
    "---",
    "",
    ...
    "---",
    "",
    "## 10. Privatization Plan (Future)",
    "",
    "When the project grows, all development will happen in a private fork (`lbm-private`) first, then selectively published to `lbm-free` via auto-accepted PRs through GitHub Actions.",
    "",
    "```",
    ...
    "```",
    "",
    "See the full doc for the GitHub Actions workflow sketch and implementation checklist.",
    "",
    "---",
    "",
