...
> This document has been moved to `docs/INTERNAL_ROADMAP.md` and is now publicly tracked.
> View it in-app: `docs.html?doc=docs/INTERNAL_ROADMAP.md`
> This file is kept as a placeholder. When this folder becomes private in the future, sensitive content will live here.

---

## Purpose

This document is the internal strategy reference for the evolution of LBM from a free, local-first tool into a sustainable, monetized product. It is a living document — update it as decisions are made and strategies evolve.
...
The `private/` folder is listed in `.gitignore` in the lbm-free (public) repo.
This means:
- Anyone who clones the public repo gets **nothing** from `private/`
- You keep it locally at all times
- It is tracked and committed **only** in `lbm-pro` (remove `private/` from lbm-pro's `.gitignore`)
...
**Full specification:** `private/SHORTCUT_MANAGEMENT_PLAN.md`
...
The following must never be pushed to `lbm-free`:

| Content | Location | Reason |
|---|---|---|
| Monetisation strategy | `private/INTERNAL_ROADMAP.md` | Competitive exposure |
| Feature specs (unreleased) | `private/SHORTCUT_MANAGEMENT_PLAN.md` | Prevents copying before launch |
...
The `.gitignore` in `lbm-free` enforces this at the file level. The PR review step is the human check before auto-merge fires.
...
2026-04-02 — Shortcut Management System added as planned USP.
             Full spec written: private/SHORTCUT_MANAGEMENT_PLAN.md
             Decision: free feature (hook for user acquisition), Pro extension = cloud profile sync.
             Private docs system formalised: private/README.md added with versioning guide.
             INTERNAL_ROADMAP corrected — was incorrectly marked as "publicly tracked".

2026-04-02 — Section 10 added: Privatization Plan (private fork workflow).
             Three-repo model sketched: lbm-private → lbm-free → lbm-pro.
             Auto-accept CI workflow drafted. Status: future / not started.
```
